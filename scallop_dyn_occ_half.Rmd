...
```
# Bundle data for JAGS & run models
# LAG 0 for Persistence; LAG 1 for Colonization
```{r}
# Get known values of z
z <- (ymat > 0)*1
z[z == 0] <- NA
...
# psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL1.depth
jdataL1L1_depth <- jdataL1L1
jdataL1L1_depth$O2 <- jdataL1L1$depth
( psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL2.depth <- 
    jagsUI::jags(jdataL1L1_depth, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.phi.sbt.o2.gam.sbt.o2.txt",
                      n.thin = 10,
    n.chains=3, n.iter=10000, n.adapt=1000, DIC=T, parallel=TRUE) )

saveRDS(psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL1.depth,
  "output/psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL1.depth.rds")
```
# Bundle data for JAGS & run models
...
# psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL3.depth
jdataL1L3_depth <- jdataL1L3
jdataL1L3_depth$O2 <- jdataL1L3$depth
( psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL3.depth <- 
    jagsUI::jags(jdataL1L3_depth, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.phi.sbt.o2.gam.sbt.o2.txt",
                      n.thin = 10,
    n.chains=3, n.iter=10000, n.adapt=1000, DIC=T, parallel=TRUE) )

saveRDS(psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL3.depth,
  "output/psi.meansbt.depth.phi.maxsbtL1.depth.gam.minsbtL3.depth.rds")
```
# check model output
```{r}
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2 <- 
  readRDS("output/psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2.rds")
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$Topt1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$width1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$Topt2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$width2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$Topt3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$width3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q2.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q97.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q2.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q97.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$mean$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q2.5$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL1.o2$q97.5$betagamO2

psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2 <- 
  readRDS("output/psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2.rds")
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$Topt1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$width1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$Topt2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$width2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$Topt3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$width3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q2.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q97.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q2.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q97.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$mean$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q2.5$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL2.o2$q97.5$betagamO2

psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2 <- 
  readRDS("output/psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2.rds")
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$Topt1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$width1
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$Topt2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$width2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$Topt3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$width3
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q2.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q97.5$betapsiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q2.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q97.5$betaphiO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$mean$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q2.5$betagamO2
psi.meansbt.o2.phi.maxsbtL1.o2.gam.minsbtL3.o2$q97.5$betagamO2
