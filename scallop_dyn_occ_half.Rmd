...
saveRDS(psi.meansbt.o2.phi.maxsbtL0.o2.gam.minsbtL3.o2,
        "output/psi.meansbt.o2.strat.phi.maxsbtL0.o2.strat.gam.minsbtL3.o2.strat.rds")
```
...
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$mean$betapsistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q2.5$betapsistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q97.5$betapsistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$mean$betaphistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q2.5$betaphistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q97.5$betaphistrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$mean$betagamstrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q2.5$betagamstrat
psi.meansbt.o2.phi.maxsbt.o2.gam.minsbt.o2$q97.5$betagamstrat
...
```{r}
plot(psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b$mean$N, 
     type = "l")

N.plot <- data.frame(
  year = 1983:2014,
  N = psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b$mean$N,
  q2.5 = psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b$q2.5$N,
  q97.5 = psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b$q97.5$N,
  q10 = apply(
    psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b$sims.list$N, 2,
...
N.plot %>%
  ...
  geom_ribbon(aes(x = year, ymin = q10, ymax = q90,
                  fill = type),
              alpha = 0.25) +
  geom_line(aes(x = year, y = N, color = type, group = type),
            size = 1) +
  scale_color_manual(values = c("firebrick", "steelblue")) +
  scale_fill_manual(values = c("firebrick", "steelblue")) +
  labs(fill = "", color = "",
       y = "No. occupied cells (out of 120)",
       x = "") +
  theme_bw()

ggsave("figures/dynocc/no_occ_patches.png",
...
```{r}
mod <- psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2

# find a typical value for phi intercept
mod$mean$phiInt
median(mod$mean$phiInt)
# year 23 is median phi annual intercept

# find a typical value for gam intercept
mod$mean$gamInt
median(mod$mean$gamInt)
# year 15 is median phi annual intercept; year 23 is close

O2pred <- seq(min(dat_train_dens80_occ$O2L1), 
              max(dat_train_dens80_occ$O2L1),
              length.out = 100)
O2predS <- wiqid::standardize2match(O2pred, O2L1_mat)

meanSBTpred <- seq(min(dat_train_dens80_occ$mean_tempL1), 
              max(dat_train_dens80_occ$mean_tempL1),
              length.out = 100)
