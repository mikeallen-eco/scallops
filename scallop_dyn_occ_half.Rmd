...
Note: the "dat" object in this chunk must be created using the code in analyze_scallop_grid2.R first. Be sure years are set to 1980-2014 in that file! (otherwise, L2 & L3 contain NA values)
```{r}
library(dplyr)
library(tidyr)
library(ggplot2)
...
# to find quantile of hauls
# quantile(dat_dens80_occ[is.na(dat_dens80_occ$dens)==F & dat_dens80_occ$dens>0,]$dens, 0.80)
...
dat_dens80_occ <- dat %>% 
  ...
  summarise(pres = sum(dens>0, na.rm = T),
            presb = sum(dens>=47, na.rm = T), 
            # 47 is top 20% of non-zero hauls
...
# matrix of number of "detected" samples per cell and year 
    # including only those that were "bonanzas" (top 20% of hauls)
...
cor(cbind(mean_temp = dat_train_dens80_occ$mean_temp,
          min_temp = dat_train_dens80_occ$min_temp,
          max_temp = dat_train_dens80_occ$max_temp,
...
")
```
# MODELS W/ 1 LINEAR COVARIATE EACH
...
jdata_L0maxmax <- 
  list(nSites = nrow(ymat), nYears = ncol(ymat), y = ymat,
    n = nmat, climvar1 = maxsbt_mat, climvar2 = maxsbt_mat, 
    climvar3 = maxsbt_mat, z = z,  
    O2a = o2_matS, O2b = o2_matS, O2c = o2_matS,
    strat = strat_matS)
str(jdata_L0maxmax)
...
jdata_L0minmin <- 
  list(nSites = nrow(ymat), nYears = ncol(ymat), y = ymat,
    n = nmat, climvar1 = minsbt_mat, climvar2 = minsbt_mat, 
    climvar3 = minsbt_mat, z = z,  
    O2a = o2_matS, O2b = o2_matS, O2c = o2_matS,
    strat = strat_matS)
str(jdata_L0minmin)
...
saveRDS(psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat,
        "D:/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat_waic.rds")
...
saveRDS(psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat,
        "D:/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat_waic.rds")

# psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL2.strat
( psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL2.strat <- 
...
saveRDS(psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL2.strat,
        "D:/scallop/2023_01_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL2.strat_waic.rds")

# psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbt.strat
( psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbt.strat <- 
    jagsUI::jags(jdata_L0maxmax, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbt.strat,
        "D:/scallop/2023_01_dynocc_output/psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbt.strat_waic.rds")

# psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL1.strat
( psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL1.strat <- 
    jagsUI::jags(jdata_L1maxmax, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL1.strat,
        "D:/scallop/2023_01_dynocc_output/psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL1.strat_waic.rds")

# psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL2.strat
( psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL2.strat <- 
    jagsUI::jags(jdata_L2maxmax, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL2.strat,
        "D:/scallop/2023_01_dynocc_output/psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL2.strat_waic.rds")

# psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbt.strat
( psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbt.strat <- 
    jagsUI::jags(jdata_L0minmin, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbt.strat,
        "D:/scallop/2023_01_dynocc_output/psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbt.strat_waic.rds")

# psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL1.strat
( psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL1.strat <- 
    jagsUI::jags(jdata_L1minmin, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL1.strat,
        "D:/scallop/2023_01_dynocc_output/psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL1.strat_waic.rds")

# psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL2.strat
( psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL2.strat <- 
    jagsUI::jags(jdata_L2minmin, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL2.strat,
        "D:/scallop/2023_01_dynocc_output/psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL2.strat_waic.rds")
```
# WAIC
```{r}
mod0 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.phi.gam_waic.rds")
# mod0 <- 
  # readRDS("results/psi.phi.gam_waic.rds")
mod1 <- 
  readRDS("/Users/mikea/Documents/mikedata/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat_waic.rds")
# mod1 <- 
  # readRDS("results/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat_waic.rds")

mod2 <- 
  readRDS("/Users/mikea/Documents/mikedata/scallop/2023_01_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat_waic.rds")

mod3 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL2.strat_waic.rds")

mod4 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbt.strat_waic.rds")

mod5 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.maxsbt.o2.strat.phi.maxsbt.o2.gam.maxsbtL1.strat_waic.rds")

mod7 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbt.strat_waic.rds")

mod8 <- 
  readRDS("D:/scallop/2023_01_dynocc_output/psi.minsbt.o2.strat.phi.minsbt.o2.gam.minsbtL1.strat_waic.rds")

loglik_full0 <- mod0$sims.list$log.lik
loglik_full1 <- mod1$sims.list$log.lik
loglik_full2 <- mod2$sims.list$log.lik
loglik_full3 <- mod3$sims.list$log.lik
loglik_full4 <- mod4$sims.list$log.lik
loglik_full5 <- mod5$sims.list$log.lik
loglik_full7 <- mod7$sims.list$log.lik
loglik_full8 <- mod8$sims.list$log.lik

loglik_wide0 <- 
  lapply(seq(dim(loglik_full0)[3]), function(x) loglik_full0[ , , x])
loglik_wide1 <- 
  lapply(seq(dim(loglik_full1)[3]), function(x) loglik_full1[ , , x])
loglik_wide2 <- 
  lapply(seq(dim(loglik_full2)[3]), function(x) loglik_full2[ , , x])
loglik_wide3 <- 
  lapply(seq(dim(loglik_full3)[3]), function(x) loglik_full3[ , , x])
loglik_wide4 <- 
  lapply(seq(dim(loglik_full4)[3]), function(x) loglik_full4[ , , x])
loglik_wide5 <- 
  lapply(seq(dim(loglik_full5)[3]), function(x) loglik_full5[ , , x])
loglik_wide7 <- 
  lapply(seq(dim(loglik_full7)[3]), function(x) loglik_full7[ , , x])
loglik_wide8 <- 
  lapply(seq(dim(loglik_full8)[3]), function(x) loglik_full8[ , , x])

loglik0 <- do.call(cbind, loglik_wide0); dim(loglik0)
loglik1 <- do.call(cbind, loglik_wide1); dim(loglik1)
loglik2 <- do.call(cbind, loglik_wide2); dim(loglik2)
loglik3 <- do.call(cbind, loglik_wide3); dim(loglik3)
loglik4 <- do.call(cbind, loglik_wide4); dim(loglik4)
loglik5 <- do.call(cbind, loglik_wide5); dim(loglik5)
loglik7 <- do.call(cbind, loglik_wide7); dim(loglik7)
loglik8 <- do.call(cbind, loglik_wide8); dim(loglik8)

waic0 <- loo::waic(loglik0); waic0 # waic 14477.8; SE158.9
loo0 <- loo::loo(loglik0); loo0
# LOOIC: Computed from 9000 by 3712 log-likelihood matrix (ran on Annotate)
# 
#          Estimate    SE
# elpd_loo  -7239.2  79.4
# p_loo       194.2   4.9
# looic     14478.5 158.9 # very similar to WAIC, which is assymptotically equivalent
waic1 <- loo::waic(loglik1); waic1
loo1 <- loo::loo(loglik1); loo1
#          Estimate    SE
# elpd_loo  -7313.5  80.1
# p_loo       197.1   5.0
# looic     14627.1 160.1
waic2 <- loo::waic(loglik2); waic2 # 14626.3 (160.1)
loo2 <- loo::loo(loglik2); loo2

# mean-mean model - Computed from 9000 by 3712 log-likelihood matrix
# 
#           Estimate    SE
# elpd_waic  -7313.2  80.0
# p_waic       196.8   5.0
# waic       14626.4 160.1
# 
# 40 (1.1%) p_waic estimates greater than 0.4. We recommend trying loo instead. 

waic3 <- loo::waic(loglik3); waic3 # 14628.5 (160.1)
loo3 <- loo::loo(loglik4); loo3

waic4 <- loo::waic(loglik4); waic4 # 14724.7 (160.9)
loo4 <- loo::loo(loglik4); loo4

waic5 <- loo::waic(loglik5); waic5 # 14731.1 161.0
loo5 <- loo::loo(loglik5); loo5

waic7 <- loo::waic(loglik7); waic7 # 14682.6 160.8
loo7 <- loo::loo(loglik7); loo7

waic8 <- loo::waic(loglik8); waic8 # 14685.9 160.8
loo8 <- loo::loo(loglik8); loo8


loo::loo_compare(waic3, waic4)
```


# SMALLER MODELS W/ JUST 1 LINEAR COVARIATE EACH
# Bundle data for JAGS & run models (mean SBT only)
# Min/Max SBT hypothesis
# LAG 0 for Persistence; LAGS 0-3 for Colonization
```{r}
# Get known values of z
z <- (ymat > 0)*1
...
# psi.meansbt.o2.strat.phi.maxsbt.o2.gam.minsbt.strat
( psi.meansbt.o2.strat.phi.maxsbt.o2.gam.minsbt.strat <- 
    jagsUI::jags(jdata_L0minmax, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 30,
    n.chains=3, n.iter=90000, n.adapt=10000, DIC=T, parallel=TRUE) )

saveRDS(psi.meansbt.o2.strat.phi.maxsbt.o2.gam.minsbt.strat,
        "D:/scallop/dynocc_output/psi.meansbt.strat.o2.phi.maxsbt.o2.gam.minsbt.strat.rds")
```
# Bonanza model (80th percentile hauls): 
# Bundle data for JAGS & run models (mean SBT only)
# Mean, mean, mean SBT hypothesis
# LAG 0 for Persistence; LAGS 0-3 for Colonization
```{r}
...
jdata_L0mean.b <- 
  list(nSites = nrow(ymat), nYears = ncol(ymat), y = ymatb,
    ...
    O2a = o2_matS, O2b = o2_matS, O2c = o2_matS, strat = strat_matS)
str(jdata_L0mean.b)
...
# psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat
( psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.b <- 
    jagsUI::jags(jdata_L0mean.b, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 10,
    n.chains=3, n.iter=10000, n.adapt=1000, DIC=T, parallel=TRUE) )

saveRDS(psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.b,
        "D:/scallop/dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.b.rds")

# psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat.b
( psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat.b <- 
    jagsUI::jags(jdata_L1mean.b, NULL, wanted, 
"scripts/scal_dyn_occ_psi.sbt.o2.strat.phi.sbt.o2.gam.sbt.strat.txt",
                      n.thin = 10,
    n.chains=3, n.iter=10000, n.adapt=1000, DIC=T, parallel=TRUE) )

saveRDS(psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat.b,
        "/Users/mikea/Documents/mikedata/scallop/2023_06_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbtL1.strat.b.rds")
...
saveRDS(colext, "figures/rmeanstrat_mmeanO2_h_dynocc/colext.rds")
saveRDS(colext_map,
        "figures/rmeanstrat_mmeanO2_h_dynocc/colext_map.rds")
...
```{r}
mod <- readRDS("/Users/mikea/Documents/mikedata/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.rds")

modb <- readRDS("/Users/mikea/Documents/mikedata/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.b.rds")  

Nest <- dat_train_dens80_occ %>%
  group_by(year) %>%
  summarize(n = sum(n>0),
            gridpres = sum(pres>0, na.rm = T),
            gridpresb = sum(presb>0, na.rm = T),
            p = gridpres / n,
            pb = gridpresb / n,
            Nest = p*116,
            Nestb = pb*116)

plot(Nest$Nest, type = "l", ylim = c(0,80))
points(Nest$Nestb, type = "l")
points(mod$mean$N, type = "l")
...
N.plot <- data.frame(
  ...
  mutate(type = forcats::fct_reorder(type, c(rep(1,32),rep(2,32))),
         N.meas = c(Nest$gridpres, Nest$gridpresb))

gamb <- apply(apply(modb$sims.list$gamma, c(1,3), mean), 2, 
      function(x)quantile(x, c(0.5)))
...
phib <- apply(apply(1-modb$sims.list$phi, c(1,3), mean), 2, 
      function(x)quantile(x, c(0.5)))
...
(np <- N.plot %>%
  ...
  geom_line(aes(x = year, y = N, linetype = type),
            size = 1) +
  geom_line(aes(x = year, y = N.meas, group = type),
            linetype = 3) +
...
saveRDS(np, "figures/rmeanstrat_mmeanO2_h_dynocc/N_occ_patches.rds")
...
(gp <- gam.plot %>%
  ...
  geom_line(aes(x = year, y = col),
            size = 1) +
  geom_line(aes(x = year, y = gamb),
            size = 1, linetype = 2) +
  labs(fill = "", color = "",
       y = "Mean colonization rate",
       x = "") +
  theme_bw() +
    theme(text = element_text(size = 14))
)

saveRDS(gp, "figures/rmeanstrat_mmeanO2_h_dynocc/Mean_col.rds")
...
(pp <- phi.plot %>%
  ...
  geom_line(aes(x = year, y = 1-phi),
            size = 1) +
  # geom_line(aes(x = year, y = phib),
            # size = 1, linetype = 3) +
  labs(fill = "", color = "",
       y = "Mean extinction rate",
       x = "") +
  theme_bw() +
    theme(text = element_text(size = 14))
)

saveRDS(pp, "figures/rmeanstrat_mmeanO2_h_dynocc/Mean_ext.rds")
...
```
# Fig. S1 - Plot mean 'environmental effects' over time (for supp.)
```{r}
# collecting posteriors
mean_phi_int_v <- qlogis(apply(mod1$sims.list$phiInt,1,mean))
mean_gam_int_v <- qlogis(apply(mod1$sims.list$gamInt,1,mean))

o2_matS2red_mat <- o2_matS[,1:31]; dim(o2_matS2red_mat)
strat_matSred <- strat_matS[,1:31]; dim(strat_matSred)
T_phi <- meansbt_mat[,1:31]; dim(T_phi)
T_gam <- meansbtL1_mat[,1:31]; dim(T_gam)
betaphiO2_v <- mod1$sims.list$betaphiO2
betagamstrat_v <- mod1$sims.list$betagamstrat

Topt_phi <- mod1$sims.list$Topt2
W_phi <- mod1$sims.list$width2
Topt_gam <- mod1$sims.list$Topt3
W_gam <- mod1$sims.list$width3

pred1_array <- array(NA, dim = c(116, 31, 9000))
pred2_array <- array(NA, dim = c(116, 31, 9000))
pred3_array <- array(NA, dim = c(116, 31, 9000))
for(i in 1:116) {
...
# part 1: the logistic part
pred1_array[i,y,z] <- plogis(mean_phi_int_v[z] 
                            + betaphiO2_v[z]*o2_matS2red_mat[i,y])    

# part 2: the Gaussian part
pred2_array[i,y,z] <- exp(-0.5*((T_phi[i,y]-Topt_phi[z])/W_phi[z])^2)
...
# part 3: combine them
pred3_array <- pred1_array * pred2_array

dim(pred3_array)

predenv_matrix <- apply(pred3_array, c(2,3), mean)

dim(predenv_matrix)
predenv = apply(predenv_matrix, 1, 
                function(x) quantile(x, c(0.025, .1, 0.5, .9, 0.975))) %>%
  t() %>%
  as.data.frame() %>%
...
predenv %>%
  ggplot() +
  geom_line(aes(x = year, y = 1-med)) +
  geom_ribbon(aes(x = year, ymin = 1-q2.5, ymax = 1-q97.5),
              fill = "darkgray", alpha = 0.5) +
  geom_ribbon(aes(x = year, ymin = 1-q10, ymax = 1-q90),
              fill = "darkgray", alpha = 0.5) +
  scale_y_continuous(limits = c(0,0.5)) +
  labs(x = "", y = "Mean environmental effects\n(predictions w/ annual intercept set at mean)",
       title = "Extinction rate") +
  theme_bw() +
  theme(text = element_text(size = 14))
)

ggsave("figures/final_figs/SupS1_enveffects_over_time_ext.jpg",
       height = 5, width = 5, dpi = 400)


# phi = (1+e^((intphi + oxygen*β ) ) )^(-1) × 
# e^(-0.5((T_(ip,y )- 〖Topt〗_3)/W_3 )^2 )

# NOW WITH COLONIZATION

pred1_array2 <- array(NA, dim = c(116, 31, 9000))
pred2_array2 <- array(NA, dim = c(116, 31, 9000))
pred3_array2 <- array(NA, dim = c(116, 31, 9000))
for(i in 1:116) {
...
# part 1: the logistic part
pred1_array2[i,y,z] <- plogis(mean_gam_int_v[z] 
                            + betagamstrat_v[z]*strat_matSred[i,y])    

# part 2: the Gaussian part
pred2_array2[i,y,z] <- exp(-0.5*((T_gam[i,y]-Topt_gam[z])/W_gam[z])^2)
...
# part 3: combine them
pred3_array2 <- pred1_array2 * pred2_array2

dim(pred3_array2)

predenv_matrix2 <- apply(pred3_array2, c(2,3), mean)

dim(predenv_matrix2)
predenv2 = apply(predenv_matrix2, 1, 
                function(x) quantile(x, c(0.025,.1, 0.5, .9,0.975))) %>%
  t() %>%
  as.data.frame() %>%
  rename(q2.5 = 1, q10 = 2, med = 3, q90 = 4, q97.5 = 5) %>%
...
ggsave("figures/final_figs/SupS1_enveffects_over_time_col.jpg",
       height = 5, width = 5, dpi = 400)
...
ggsave("figures/final_figs/SupS1_enveffects_over_time_both.jpg",
       height = 9, width = 4, dpi = 400)
```
...
ggsave("figures/dynocc/scallop_dynocc_predicted_colext_rmeanO2strat_mmeanO2strat.png",
        height = 5, width = 5, dpi = 400)
```
# Bonanza (top 80% abundance) model: Map mean colonization - extinction by patch
```{r}
psi.meansbt.o2.phi.meansbtL0.o2.gam.meansbtL1.o2.b <- 
  readRDS("/Users/mikea/Documents/mikedata/scallop/2022_11_12_dynocc_output/psi.meansbt.o2.strat.phi.meansbt.o2.gam.meansbt.strat.b.rds")
