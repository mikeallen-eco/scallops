...
parameters{
  ...
  real<lower = 0, upper = 0.8> p_length_50_sel; // length at 50% selectivity
...
// commented out while using manual_selectivity==1 - couldn't get if statement to work
  ...
  // if estimating selectivity ogive (commenting as if statement won't work)
  //   if(manual_selectivity == 0){
